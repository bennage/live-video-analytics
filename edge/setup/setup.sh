...
if [[ "$OWN_DEVICE" == "N" ]]; then
    ...
    echo "VIDEO_INPUT_FOLDER_ON_DEVICE=\"/home/$IOT_EDGE_VM_ADMIN/samples/input\"" >> $ENV_FILE
    ...
    sed -i "s/\$VIDEO_INPUT_FOLDER_ON_DEVICE/\/home\/$IOT_EDGE_VM_ADMIN\/samples\/input/" $DEPLOYMENT_MANIFEST_FILE
...
##################################################################################################################################################    
    ...
    echo "VIDEO_INPUT_FOLDER_ON_DEVICE=\"/home/$IOT_EDGE_VM_ADMIN/samples/input\"" >> $BYOD_ENV_FILE
    ...
    sed -i "s/\$VIDEO_INPUT_FOLDER_ON_DEVICE/\/home\/$IOT_EDGE_VM_ADMIN
    \/samples\/input/" $BYOD_DEPLOYMENT_MANIFEST_FILE
